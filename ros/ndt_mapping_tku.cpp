...
static std::chrono::time_point<std::chrono::system_clock> matching_start1, matching_end1;
static std::chrono::time_point<std::chrono::system_clock> matching_start2, matching_end2;
static std::chrono::time_point<std::chrono::system_clock> matching_start3, matching_end3;
static std::chrono::time_point<std::chrono::system_clock> matching_start4, matching_end4;
static std::chrono::time_point<std::chrono::system_clock> matching_start5, matching_end5;
static std::chrono::time_point<std::chrono::system_clock> matching_start6, matching_end6;
static std::chrono::time_point<std::chrono::system_clock> matching_start7, matching_end7;
static std::chrono::time_point<std::chrono::system_clock> matching_start8, matching_end8;
static std::chrono::time_point<std::chrono::system_clock> matching_start9, matching_end9;
static std::chrono::time_point<std::chrono::system_clock> matching_start10, matching_end10;
static std::chrono::time_point<std::chrono::system_clock> matching_start11, matching_end11;
static std::chrono::time_point<std::chrono::system_clock> matching_start12, matching_end12;
static std::chrono::time_point<std::chrono::system_clock> matching_start13, matching_end13;
static std::chrono::time_point<std::chrono::system_clock> matching_start14, matching_end14;
static std::chrono::time_point<std::chrono::system_clock> matching_start15, matching_end15;
static std::chrono::time_point<std::chrono::system_clock> matching_start16, matching_end16;
static std::chrono::time_point<std::chrono::system_clock> matching_start17, matching_end17;
static std::chrono::time_point<std::chrono::system_clock> matching_start18, matching_end18;
static std::chrono::time_point<std::chrono::system_clock> matching_start19, matching_end19;
static double exe_time = 0.0;
static double exe_time1 = 0.0;
static double exe_time2 = 0.0;
static double exe_time3 = 0.0;
static double exe_time4 = 0.0;
static double exe_time5 = 0.0;
static double exe_time6 = 0.0;
static double exe_time7 = 0.0;
static double exe_time8 = 0.0;
static double exe_time9 = 0.0;
static double exe_time10 = 0.0;
static double exe_time11 = 0.0;
static double exe_time12 = 0.0;
static double exe_time13 = 0.0;
static double exe_time14 = 0.0;
static double exe_time15 = 0.0;
static double exe_time16 = 0.0;
static double exe_time17 = 0.0;
static double exe_time18 = 0.0;
static double exe_time19 = 0.0;
...
static std::ofstream ofs, ofs1, ofs2, ofs3, ofs4;
static std::string filename, filename1, filename2, filename3, filename4;
...
//matching_start14 = std::chrono::system_clock::now();
    for (int i = 0; i < (int)msg->points.size(); i++)
    {
      scan.points.push_back(pcl::PointXYZ(msg->points[i].x, msg->points[i].y, msg->points[i].z));
    }
//matching_end14 = std::chrono::system_clock::now();
    scan.header = msg->header;
//matching_start15 = std::chrono::system_clock::now();
    pcl::PointCloud<pcl::PointXYZ>::Ptr scan_ptr(new pcl::PointCloud<pcl::PointXYZ>(scan));
    pcl::PointCloud<pcl::PointXYZ>::Ptr filtered_scan_ptr(new pcl::PointCloud<pcl::PointXYZ>);

    pcl::VoxelGrid<pcl::PointXYZ> voxel_grid_filter;
//matching_end15 = std::chrono::system_clock::now();

//matching_start16 = std::chrono::system_clock::now();
    //voxel_grid_filter.setLeafSize(0.5, 0.5, 0.5);
    voxel_grid_filter.setLeafSize(2.0, 2.0, 2.0);
//matching_end16 = std::chrono::system_clock::now();
//matching_start17 = std::chrono::system_clock::now();
    voxel_grid_filter.setInputCloud(scan_ptr);
//matching_end17 = std::chrono::system_clock::now();
//matching_start18 = std::chrono::system_clock::now();
    voxel_grid_filter.filter(*filtered_scan_ptr);
//matching_end18 = std::chrono::system_clock::now();
    j = 0;
//matching_start19 = std::chrono::system_clock::now();
...
//matching_end19 = std::chrono::system_clock::now();
    scan_points_num = j;
...
//exe_time14 = std::chrono::duration_cast<std::chrono::microseconds>(matching_end14 - matching_start14).count() / 1000.0;
//exe_time15 = std::chrono::duration_cast<std::chrono::microseconds>(matching_end15 - matching_start15).count() / 1000.0;
//exe_time16 = std::chrono::duration_cast<std::chrono::microseconds>(matching_end16 - matching_start16).count() / 1000.0;
//exe_time17 = std::chrono::duration_cast<std::chrono::microseconds>(matching_end17 - matching_start17).count() / 1000.0;
//exe_time18 = std::chrono::duration_cast<std::chrono::microseconds>(matching_end18 - matching_start18).count() / 1000.0;
//exe_time19 = std::chrono::duration_cast<std::chrono::microseconds>(matching_end19 - matching_start19).count() / 1000.0;
  ofs3 /*<< "Number of scan points: "*/ << msg->header.seq << " , ";
  ofs3 /*<< "keisoku8_matching(iteration): "*/ << exe_time1 << " , ";
  ofs3 /*<< "keisoku8_matching(iteration): "*/ << exe_time14 << " , ";
  ofs3 /*<< "keisoku9_matching(gps-resetting): "*/ << exe_time15 << " , ";
  ofs3 /*<< "keisoku8_matching(iteration): "*/ << exe_time16 << " , ";
  ofs3 /*<< "keisoku9_matching(gps-resetting): "*/ << exe_time17 << " , ";
  ofs3 /*<< "keisoku8_matching(iteration): "*/ << exe_time18 << " , ";
  ofs3 /*<< "keisoku9_matching(gps-resetting): "*/ << exe_time19;
  ofs3 /*<< "keisoku10_matching(unti-distortion): "*/ << std::endl;
...
*/
  ...
  // matching
matching_start3 = std::chrono::system_clock::now();
  for (layer_select = 1; layer_select >= 1; layer_select -= 1)
  {
    //    	printf("layer=%d\n",layer_select);
//matching_start8 = std::chrono::system_clock::now();
    iteration_counter = 0;
    for (j = 0; j < 100; j++)
    {
      ...
      bpose = pose;
//matching_start11 = std::chrono::system_clock::now();
      e = adjust3d(scan_points, scan_points_num, &pose, layer_select);
//      e = adjust3d(scan_points, scan_points_num, &pose, layer_select,ofs4);
//matching_end11 = std::chrono::system_clock::now();
      //	printf("%f\n",e);

//matching_start12 = std::chrono::system_clock::now();
      pose_mod(&pose);
//matching_end12 = std::chrono::system_clock::now();
      iteration_counter++;
    //exe_time11 = std::chrono::duration_cast<std::chrono::microseconds>(matching_end11 - matching_start11).count() / 1000.0;
    //exe_time12 = std::chrono::duration_cast<std::chrono::microseconds>(matching_end12 - matching_start12).count() / 1000.0;
    //ofs2 /*<< "Number of scan points: "*/ << msg->header.seq << " , ";
    //ofs2 << exe_time11 << " , ";
    //ofs2 << exe_time12 << " , ";


//matching_start13 = std::chrono::system_clock::now();
...
//matching_end13 = std::chrono::system_clock::now();
      //exe_time13 = std::chrono::duration_cast<std::chrono::microseconds>(matching_end13 - matching_start13).count() / 1000.0;
    //ofs2 << exe_time13 << std::endl;
    }
    iteration = j;
//matching_end8 = std::chrono::system_clock::now();

    /*gps resetting*/
//matching_start9 = std::chrono::system_clock::now();
    if (g_use_gnss)
    {
      static FILE *e_fp;
      if (!e_fp)
...
//matching_end9 = std::chrono::system_clock::now();
    // unti-distotion
//matching_start10 = std::chrono::system_clock::now();
    if (layer_select == 2 && 1)
    {
...
//matching_end10 = std::chrono::system_clock::now();
  }
matching_end3 = std::chrono::system_clock::now();

  // localizer
matching_start4 = std::chrono::system_clock::now();
...
matching_end4 = std::chrono::system_clock::now();

  // base_link
matching_start5 = std::chrono::system_clock::now();
...
matching_end5 = std::chrono::system_clock::now();

  // update ND map
matching_start6 = std::chrono::system_clock::now();
...
*/
matching_end6 = std::chrono::system_clock::now();

matching_start7 = std::chrono::system_clock::now();
...
matching_end7 = std::chrono::system_clock::now();
  ...
  exe_time3 = std::chrono::duration_cast<std::chrono::microseconds>(matching_end3 - matching_start3).count() / 1000.0;
  exe_time4 = std::chrono::duration_cast<std::chrono::microseconds>(matching_end4 - matching_start4).count() / 1000.0;
  exe_time5 = std::chrono::duration_cast<std::chrono::microseconds>(matching_end5 - matching_start5).count() / 1000.0;
  exe_time6 = std::chrono::duration_cast<std::chrono::microseconds>(matching_end6 - matching_start6).count() / 1000.0;
  exe_time7 = std::chrono::duration_cast<std::chrono::microseconds>(matching_end7 - matching_start7).count() / 1000.0;
  exe_time8 = std::chrono::duration_cast<std::chrono::microseconds>(matching_end8 - matching_start8).count() / 1000.0;
  exe_time9 = std::chrono::duration_cast<std::chrono::microseconds>(matching_end9 - matching_start9).count() / 1000.0;
  exe_time10 = std::chrono::duration_cast<std::chrono::microseconds>(matching_end10 - matching_start10).count() / 1000.0;


  //std::cout << "-----------------------------------------------------------------" << std::endl;
  //std::cout << "ndt_mapping_tku" << std::endl;
...
/*
  std::cout << "keisoku1_downsampler_voxelgrid: " << exe_time1 << std::endl;
  std::cout << "keisoku2_downsampler_distance: " << exe_time2 << std::endl;
  std::cout << "keisoku3_matching: " << exe_time3 << std::endl;
  std::cout << "keisoku4_localizer: " << exe_time4 << std::endl;
  std::cout << "keisoku5_baselink: " << exe_time5 << std::endl;
  std::cout << "keisoku6_updateNDmap: " << exe_time6 << std::endl;
  std::cout << "keisoku7_others: " << exe_time7 << std::endl;
  std::cout << "keisoku8_matching(iteration): " << exe_time8 << std::endl;
  std::cout << "keisoku9_matching(gps-resetting): " << exe_time9 << std::endl;
  std::cout << "keisoku10_matching(unti-distortion): " << exe_time10 << std::endl;
*/
...
/*
std::cout << "Seq(mapping_tku), " << msg->header.seq << " , ";
std::cout <<  "keisoku3_matching: " << exe_time3 << " , ";
std::cout << "keisoku8_matching(iteration): " << exe_time8 << " , ";
std::cout << "keisoku9_matching(gps-resetting): " << exe_time9 << " , ";
std::cout << "keisoku10_matching(unti-distortion): " << exe_time10 << std::endl;
*/
  ofs1 << "-ndt_mapping_tku" << " , ";
  ofs1  << msg->header.seq << " , ";
  ofs1 /*<< "Number of scan points: "*/ << msg->size() << " , ";
  ofs1 /*<< "Number of filtered scan points: "*/ << scan_points_num << " , ";
  ofs1 /*<< "Number of iteration: "*/ << iteration << " , ";
  ofs1 << iteration_counter << " , ";
  ofs1 /*<< "Execution time: "*/ << exe_time << " , ";
  ofs1 /*<< "keisoku1_downsampler_voxelgrid: "*/ << exe_time1 << " , ";
  ofs1 /*<< "keisoku2_downsampler_distance: "*/ << exe_time2 << " , ";
  ofs1 /*<< "keisoku3_matching: "*/ << exe_time3 << " , ";
  ofs1 /*<< "keisoku4_localizer: "*/ << exe_time4 << " , ";
  ofs1 /*<< "keisoku5_baselink: "*/ << exe_time5 << " , ";
  ofs1 /*<< "keisoku6_updateNDmap: "*/ << exe_time6 << " , ";
  ofs1 /*<< "keisoku7_others: "*/ << exe_time7 << " , ";
  ofs1 /*<< "keisoku8_matching(iteration): "*/ << exe_time8 << " , ";
  ofs1 /*<< "keisoku9_matching(gps-resetting): "*/ << exe_time9 << " , ";
  ofs1 /*<< "keisoku10_matching(unti-distortion): "*/ << exe_time10 << " , ";
//  ofs1 << "(x,y,z,roll,pitch,yaw):" << std::endl;
  ofs1 /*<< "("*/ << pose.x << " , " << pose.y << " , " << pose.z << " , " << pose.theta << " , " << pose.theta2 << " , "
          << pose.theta3 << std::endl;
...
int main(int argc, char *argv[])
{
  ...
  ofs << "tl:translation/rotation1 , " << "tl:translation/rotation2 , " << "map_path , " << "tl:translation/rotation3 , " << "init=NDmap , " << "load_map , " << "ndmap_pub , " << "ndt_pose_pub , " << "localizer_pose_pub , " << "points_sub , " << "save_nd_map" << std::endl;
