...
double adjust3d_cuda_parallel(int GRID,int BLOCK,NDMapPtr NDmap_dev, NDPtr NDs, PointPtr scan, PointPtr scan_points_dev, int num, PosturePtr initial, int target, double E_THETA);
void cudaReset();
